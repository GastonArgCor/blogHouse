...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\sistemas\\CURSOS\\CURSO NEXTJS\\criaderoHouse\\criaderoHouse\\prisma\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\sistemas\\CURSOS\\CURSO NEXTJS\\criaderoHouse\\criaderoHouse\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/prisma\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Blog {\n  id          String   @id @default(auto()) @map(\"_id\") @db.ObjectId // Id único y generado automáticamente\n  title       String // Título del blog\n  description String // Descripción del blog\n  createdAt   DateTime @default(now()) // Fecha de creación del blog\n}\n",
  "inlineSchemaHash": "9aad388295978373950ac94d893b66c611916eff2d78d861e6681584e3813521",
  "copyEngine": true
}
config.dirname = '/'
